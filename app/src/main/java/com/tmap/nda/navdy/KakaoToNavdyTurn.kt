...
/**
 * 카카오내비 SDK의 KNRGCode(방향 안내 코드 문자열)를 Navdy 프로토콜의
 * NavigationTurn enum 값으로 변환.
 *
 * app/src/main/java/com/tmap/nda/hud/TmapNdaCarAppService.kt 의
 * maneuverType()/maneuverFromAngle() 매핑을 그대로 따르되,
 * androidx.car.app.Maneuver 대신 Navdy NavigationTurn으로 대응시킴.
 */
